...
- `src/services/prototypeWallet.ts` mantém saldo em centavos, posições por rodada, IDs de créditos já aplicados e o histórico persistente das operações simuladas, sem integrar qualquer movimentação financeira real.
